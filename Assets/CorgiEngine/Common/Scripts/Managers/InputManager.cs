...
namespace MoreMountains.CorgiEngine
{
	...
	public class InputManager : MMSingleton<InputManager>
	{
        ...
        /// the block button
        public MMInput.IMButton BlockButton { get; protected set; }
		...
		protected virtual void InitializeButtons()
		{
            ...
            ButtonList.Add(BlockButton = new MMInput.IMButton(PlayerID, "Block", BlockButtonDown, BlockButtonPressed, BlockButtonUp));
        ...
        public virtual void BlockButtonDown()               { BlockButton.State.ChangeState(MMInput.ButtonStates.ButtonDown); }
        public virtual void BlockButtonPressed()            { BlockButton.State.ChangeState(MMInput.ButtonStates.ButtonPressed); }
        public virtual void BlockButtonUp()                 { BlockButton.State.ChangeState(MMInput.ButtonStates.ButtonUp); }
